...
- (void)twitterNicholas {
    [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"https://twitter.com/itsnicho1as"]];
}
...
- (void)donateNicholas {
    [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"https://paypal.me/nicholasdev"]];
}
